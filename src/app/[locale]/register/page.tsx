...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-background overflow-hidden">
      {/* Left Side - Form (Swapped for Register) */}
      <div className="flex flex-col items-center justify-center p-8 lg:p-12 order-2 lg:order-1 relative">
      ...
      <div className="hidden lg:block relative overflow-hidden bg-black order-1 lg:order-2">
        <video 
          autoPlay 
          loop 
          muted 
        ...
        >
          <source src="/hq-impact.mp4" type="video/mp4" />
        </video>
